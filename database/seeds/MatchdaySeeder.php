...
class MatchdaySeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('matchdays')->insertOrIgnore([  // DB::table('users')->insertGetId->insertOrIgnore([
            ...
            ['id' => 7, 'gamedate' => '2020-08-30', 'gametime' => '14:00', 'hometeam' => 'THC von Horn und Hamm III', 'awayteam' => 'THCC RG Hamburg', 'venue_street' => 'Saarlandstraße', 'venue_housenumber' => '69', 'venue_zip' => 22303, 'venue_city' => 'Hamburg', 'result_hometeam' => '', 'result_awayteam' => '', 'created_at' => now(), 'updated_at' => now()],
