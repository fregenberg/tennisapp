...
class MatchdaySeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('matchdays')->insertOrIgnore([
            ...
            ['id' => 9, 'gamedate' => '2020-06-13', 'gametime' => '14:00', 'hometeam' => 'TC Groß Borstel II', 'awayteam' => 'THC von Horn und Hamm III', 'venue_street' => 'Paeplowweg', 'venue_housenumber' => '6', 'venue_zip' => 22453, 'venue_city' => 'Hamburg', 'result_hometeam' => '', 'result_awayteam' => '', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 8, 'gamedate' => '2020-06-28', 'gametime' => '14:00', 'hometeam' => 'THC von Horn und Hamm III', 'awayteam' => 'TG Elbe Bille', 'venue_street' => 'Saarlandstraße', 'venue_housenumber' => '69', 'venue_zip' => 22303, 'venue_city' => 'Hamburg', 'result_hometeam' => '', 'result_awayteam' => '', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['id' => 6, 'gamedate' => '2020-09-05', 'gametime' => '14:00', 'hometeam' => 'TG Heimfeld', 'awayteam' => 'THC von Horn und Hamm III', 'venue_street' => 'Am Waldschlößchen', 'venue_housenumber' => '1', 'venue_zip' => 21075, 'venue_city' => 'Hamburg', 'result_hometeam' => '', 'result_awayteam' => '', 'created_at' => now(), 'updated_at' => now()]
        ]);
    }
}
